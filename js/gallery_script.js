...
const folderData = {
  ...
  "Field Trips/2022 10(Oct) Tumkur University": generatePhotos(9),
  "Field Trips/2023 10(Oct) Kolar": generatePhotos(33),
  "Events/2022 04(April) Geoinnovation": generatePhotos(5),
  "Events/2022 09(Sept) Onam Celebration": generatePhotos(6),
  "Events/2022 11(Nov) IEEE-GRSS HandsOn Workshop": generatePhotos(5),
  "Events/2023 03(Mar) DST Winter Training Program": generatePhotos(58),
  "Events/2023 10(Oct) IEEE Day - i3 Event": generatePhotos(9),
  "Events/2023 12(Dec) 18Dec GIS Day": generatePhotos(3),
  "Places/Agra": generatePhotos(1),
  "Places/Bengaluru": generatePhotos(1),
  "Places/Bhopal": generatePhotos(1),
  "Places/Gwalior": [
    { name: "fort.jpg", type: "photo" }
  ],
  "Places/Hampi": generatePhotos(122),
  "Places/Hogenakkal": generatePhotos(10),
  "Places/Indore": generatePhotos(1),
  "Places/Jhansi": generatePhotos(2),
  ...
  "Places/Sultanpur": generatePhotos(1),
};
